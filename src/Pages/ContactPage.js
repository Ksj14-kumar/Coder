    ...
    return (
        <div>
            ...
            <div className="contact-sect">
                <Contactitem icon={phone} text1={"+91 9149077008"} text2={""} title={"Phone"}/>
                <Contactitem icon={email} text1={"sanjucom14998@gmail.com"} text2={"jsondata74@gmail.com"} title={"Email"}/>
